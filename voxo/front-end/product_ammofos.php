                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-7">
                                <div class="cloth-details-size">
                                    ...
                                    <h3 class="active-price-detail">საცალო ფასი: ₾<span id="unitprice">160.00</span></h3><h3 class="active-price-discount"> საბითუმო ფასი: ₾<span id="wholesaleprice">155.00</span></h3>
