                                ...
                                <div class="details-image ratio_asos">
                                    <div>
                                        <div class="product-image-tag">
                                            <img src="assets/images/products/hp-7-tires.jpg" id="zoom_01"
                                                data-zoom-image="assets/images/products/hp-7-tires.jpg"
                        ...
                        <div class="col-md-7">
                            <div class="cloth-details-size">
                                ...
                                <div class="details-image-concept">
                                    <h2>ხელის კულტივატორი "ბუფალო" 7 HP - მსხვილ ღერძზე</h2>
                                </div>
                                ...
                                <h3 class="price-detail">₾<span id="pricetag">2000.00</span></h3>
                                ...
                                <div id="selectSize" class="addeffect-section product-description border-product">
                                    ...
                                    <div class="size-box">
                                        <ul>
                                            <li class="pricechange active" id="activeprice" value="2000" realvalue="2000">
