                                ...
                                <div class="details-image ratio_asos">
                                    <div>
                                        <div class="product-image-tag">
                                            <img src="assets/images/products/hiromiki-2.jpg" id="zoom_01"
                                                data-zoom-image="assets/images/products/hiromiki-2.jpg"
                        ...
                        <div class="col-md-7">
                            <div class="cloth-details-size">
                                ...
                                <div class="details-image-concept">
                                    <h2>ხელის კულტივატორი "ჰირომიკი" MQ177-4</h2>
                                </div>
                                ...
                                <h3 class="price-detail">₾<span id="pricetag">2800.00</span></h3>
                                ...
                                <div id="selectSize" class="addeffect-section product-description border-product">
                                    ...
                                    <div class="size-box">
                                        <ul>
                                            <li class="pricechange active" id="activeprice" value="2800" realvalue="2800">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="desc">
                            <div class="shipping-chart">
                                <div class="part">
                                    <h4 class="inner-title mb-2">ხელის კულტივატორი "ჰირომიკი" MQ177-4</h4>
                                    <ul>
                                        <li>მოდელი: MQ170-4EC</li>
                                        <li>ძრავის მოდელი: 177F  </li>
                                        <li>დამუშავების სიგრძე (მმ): 1150  </li>
                                        <li>დამუშავების სიღრმე (მმ): 150-300</li>
                                        <li>სიმძლავრე (ცხ/ძ - ბრუნი): 7 ცხ/ძ - 3600</li>
                                        <li>გადაცემათა კოლოფი: -1,2,0,1</li>
                                        <li>საწვავის ტევადობა: 6.0</li>
                                        <li>წონა (კგ): 139</li>
                                        <li>დამზადების თარიღი: 06.2021</li>
                                        <li>გარანტია (თვე): 12</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
