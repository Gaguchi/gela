                                ...
                                <div class="details-image ratio_asos">
                                    <div>
                                        <div class="product-image-tag">
                                            <img src="assets/images/products/line-1.jpg" id="zoom_01"
                                                data-zoom-image="assets/images/products/line-1.jpg"
                        ...
                        <div class="col-md-7">
                            <div class="cloth-details-size">
                                ...
                                <div class="details-image-concept">
                                    <h2>ბალახის საჭრელი ძუა 100 მ. 4.00</h2>
                                </div>
                                ...
                                <h3 class="price-detail">₾<span id="pricetag">75.00</span></h3>
                                ...
                                <div id="selectSize" class="addeffect-section product-description border-product">
                                    ...
                                    <div class="size-box">
                                        <ul>
                                            <li class="pricechange active" id="activeprice" value="75" realvalue="75">
