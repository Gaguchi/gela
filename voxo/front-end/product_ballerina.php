                            ...
                            <div class="col-md-6">
                                <div class="cloth-details-size">
                                    ...
                                    <div id="selectSize" class="addeffect-section product-description border-product">
                                        ...
                                        <div class="size-box">
                                            <ul>
                                                <li class="pricechange active" id="activeprice" value="22">
                                                    <a href="javascript:void(0)">500 მლ.გრ.</a>
                                                </li>
                                                <li class="pricechange" value="40">
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="col-lg-8">
                                            ...
                                            <ol>
                                                ...
                                                <li>მოქმედების მაღალი სიჩქარე</li>
                                                <li>გამოყენების ფართო "ფანჯარა" (მარცვლოვანი კულტურების მეორე კვანძის ფაზამდე და 3 ფაზაში - სიმინდის 5 ფოთოლი)</li>
                                                <li>შემდგომი ეფექტის ნაკლებობა და გამოყენების შესაძლებლობა ყველა სახის მოსავლის როტაციაში</li>
                                            </ol>

                                            <div class="part mt-3">
                                                <h4 class="inner-title mb-2">პრეპარატის დანიშვნა:</h4>
                                                <p class="font-light">სისტემური შერჩევითი გაჩენის შემდგომი ჰერბიციდი წლიური ორკოტილედონების კონტროლისთვის, მათ შორის 2,4-D და MCPA-ს მიმართ რეზისტენტული და ზოგიერთი მრავალწლიანი ძირეული სარეველა მარცვლეულის, სიმინდის, ფეტვისა და სორგოს კულტურებში.</p>
                                                <br>
                                                <h4 class="inner-title mb-2">გამოყენების რეკომენდაციები:</h4>
                                                <p class="font-light">ერთწლოვანი ორწახნაგოვანი სარეველები ყველაზე დაუცველია ბალერინას მიმართ 2-6 ფოთლის ფაზაში (სიმაღლე 5-10 სმ), მრავალწლოვანი ფესვის სარეველა - როზეტის ფაზაში ღერომდე.

მაქსიმალური მოხმარების მაჩვენებელი გამოიყენება: საწყისი მაღალი დაბინძურების შემთხვევაში; კულტურებში მრავალწლოვანი ფესვის სარეველების გაბატონება; ზედმეტად გაზრდილი სარეველების არსებობა (მდგრადი საწოლები 15 - 20 სმ სიმაღლეზე, გვირილის სახეობები - 20 სმ-მდე, თესვა ეკალი და ეკლის სახეობები - კვირტის დაწყებამდე).

დამუშავების დროს ტემპერატურის რეჟიმი არის 5-დან 25 ° C-მდე, მაგრამ ყველაზე ოპტიმალური ტემპერატურაა 8-დან 25 ° C-მდე, როდესაც სარეველა აქტიურად იზრდება და პრეპარატი უფრო სწრაფად მოქმედებს. არ არის რეკომენდებული დამუშავების ჩატარება იმ დღეებში, როდესაც მოსალოდნელია ღამის ყინვები და მათ შემდეგ, პრეპარატის ეფექტურობის შემცირების შესაძლებლობის გამო.

სამუშაო ხსნარის მოსამზადებლად წყალი უნდა მომზადდეს Soylent კონდიციონერის გამოყენებით.</p>
                                            </div>
                                        </div>
