                    ...
                    <div class="row g-4">
                                ...
                                <div class="details-image ratio_asos">
                                    <div>
                                        <div class="product-image-tag">
                                            <img src="assets/images/products/cart.jpg" id="zoom_01"
                                                data-zoom-image="assets/images/products/cart.jpg"
                        ...
                        <div class="col-md-7">
                            <div class="cloth-details-size">
                                ...
                                <h3 class="price-detail">₾<span id="pricetag">2100.00</span></h3>
                                ...
                                <div id="selectSize" class="addeffect-section product-description border-product">
                                    ...
                                    <div class="size-box">
                                        <ul>
                                            <li class="pricechange active" id="activeprice" value="2100" realvalue="2100">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="desc">
                            <div class="shipping-chart">
                                <div class="part">
                                    <h4 class="inner-title mb-2">კულკტივატორის მისაბმელი</h4>
                                    <ul>
                                        <li>თავსებადია ნებისმიერ კულტივატორთან</li>
                                        <li>ბორტის სიგანე: 1.00 მ</li>
                                        <li>ბორტის სიგრძე: 1.50 მ</li>
                                        <li>ბორტის სიმაღლე: 0.30 მ</li>
                                        <li>საბურავის ზომა 4.00-12</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
