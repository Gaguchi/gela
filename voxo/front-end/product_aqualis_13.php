                                    ...
                                    <div class="details-image ratio_asos">
                                        <div>
                                            <div class="product-image-tag">
                                                <img src="assets/images/products/aqualis-13.jpg" id="zoom_01"
                                                    data-zoom-image="assets/images/products/aqualis-13.jpg"
                                        ...
                                        <div class="size-box">
                                            <ul>
                                                ...
                                                <li class="pricechange"  value="33" realvalue="30">
                                                    <a href="javascript:void(0)">5 კგ.</a>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="desc">
                                <div class="shipping-chart">
                                    <div class="part">
                                        <h4 class="inner-title mb-2">აკვალის 10.26.26</h4>
                                        <p class="font-light">საწყისი ფოსფორის წყარო.</p>
                                    </div>
                                    <div class="row g-3 align-items-center">
                                        <div class="part col-lg-8">
                                            ...
                                            <ol>
                                                ...
                                                <li>იდეალური ხსნარი ფოთლოვანი გამოყენებისთვის</li>
                                            </ol>
                                ...
                                <div class="pro mb-4">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-part">
                                            <tr>
                                                <th>აზოტის საერთო (N), არანაკლებ</th><td>13%</td>
                                            </tr>
                                            <tr class="subtable">
                                                <th><span>ამონიუმის აზოტი (NH4), არანაკლებ</span></th><td>9%</td>
                                            </tr>
                                            <tr class="subtable">
                                                <th><span>ნიტრატი აზოტი (NO3), არანაკლებ</span></th><td>4%</td>
                                            </tr>
                                            <tr>
                                                <th>სულ ფოსფატები P2O5-ის მიხედვით, არანაკლებ</th><td>40%</td>
                                            </tr>
                                            <tr>
                                                <th>კალიუმი, არანაკლებ</th><td>13%</td>
                                            </tr>
                                            <tr>
