                            ...
                            <div class="col-md-7">
                                <div class="cloth-details-size">
                                    ...
                                    <div class="details-image-concept">
                                        <h2>აკვალის 20.20.20</h2>
                                    </div>

                                    <div class="label-section">
                                        <span class="badge badge-grey-color">წყალხსნადი სასუქი</span>
                                    </div>
                                    <h3 class="price-detail">₾<span id="pricetag">115.00</span> <del id="oldprice"></del> <span id="discount"></span></h3>
                                    <h3 class="active-price-detail">საცალო ფასი: ₾<span id="unitprice">115.00</span></h3><h3 class="active-price-discount"> საბითუმო ფასი: ₾<span id="wholesaleprice">110.00</span></h3><h3 class="mb-3"><span id="until-discount">დარჩა 10 საბითუმო ფასამდე</span></h3>
                                    ...
                                    <div id="selectSize" class="addeffect-section product-description border-product">
                                        ...
                                        <div class="size-box">
                                            <ul>
                                                <li class="pricechange active" id="activeprice" value="115" realvalue="110">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="desc">
                                <div class="shipping-chart">
                                    <div class="part">
                                        <h4 class="inner-title mb-2">აკვალის 20.20.20</h4>
                                ...
                                <div class="pro mb-4">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-part">
                                            <tr>
                                                <th>აზოტის საერთო (N), არანაკლებ</th><td>20.2%</td>
                                            </tr>
                                            <tr class="subtable">
                                                <th><span>ამონიუმის აზოტი, არანაკლებ</span></th><td>4%</td>
                                            </tr>
                                            <tr class="subtable">
                                                <th><span>ნიტრატი აზოტი, არანაკლებ</span></th><td>6%</td>
                                            </tr>
                                            <tr class="subtable">
                                                <th><span>ამიდური აზოტი, არანაკლებ</span></th><td>10.2%</td>
                                            </tr>
                                            <tr>
                                                <th>სულ ფოსფატები P2O5-ის მიხედვით, არანაკლებ</th><td>20.3%</td>
                                            </tr>
                                            <tr>
                                                <th>კალიუმი, არანაკლებ</th><td>20.3%</td>
                                            </tr>
                                            <tr>
