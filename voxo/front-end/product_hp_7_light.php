                                ...
                                <div class="details-image ratio_asos">
                                    <div>
                                        <div class="product-image-tag">
                                            <img src="assets/images/products/hp-7-lights.jpg" id="zoom_01"
                                                data-zoom-image="assets/images/products/hp-7-lights.jpg"
                        ...
                        <div class="col-md-7">
                            <div class="cloth-details-size">
                                ...
                                <div class="details-image-concept">
                                    <h2>ხელის კულტივატორი "ბუფალო" 7 HP - განათებით</h2>
                                </div>
                                ...
                                <h3 class="price-detail">₾<span id="pricetag">1900.00</span></h3>
                                ...
                                <div id="selectSize" class="addeffect-section product-description border-product">
                                    ...
                                    <div class="size-box">
                                        <ul>
                                            <li class="pricechange active" id="activeprice" value="1900" realvalue="1900">
