                        ...
                        <div class="row g-4">
                                    ...
                                    <div class="details-image ratio_asos">
                                        <div>
                                            <div class="product-image-tag">
                                                <img src="assets/images/products/rus-gvarjila.jpg" id="zoom_01"
                                                    data-zoom-image="assets/images/products/rus-gvarjila.jpg"
                            ...
                            <div class="col-md-7">
                                <div class="cloth-details-size">
                                    ...
                                    <h3 class="active-price-detail">საცალო ფასი: ₾<span id="unitprice">105.00</span></h3><h3 class="active-price-discount"> საბითუმო ფასი: ₾<span id="wholesaleprice">100.00</span></h3>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="desc">
                                <div class="shipping-chart">
                                    <div class="part">
                                        <h4 class="inner-title mb-2">რუსული გვარჯილა</h4>
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="part col-lg-8">
                                            ...
                                            <ol>
                                                <li>აზოტი ფორმებში ხელმისაწვდომია სწრაფი და ხანგრძლივი შთანთქმისთვის</li>
                                                <li>გამოირჩევა გრანულების გაზრდილი სიმტკიცით და ნელი ხსნადობით, უფრო დიდხანს რჩება ნიადაგში და კვებავს მცენარეებს</li>
                                                <li>გავრცელებისას უფრო მაღალი მომგებიანობა - გავრცელებისას უფრო ფართო დაფარვა (+40% ამონიუმის ნიტრატზე) - მინდვრის გასაშენებლად საჭიროა ნაკლები უღელტეხილი</li>
                                                <li>ვარგისია ადრე გაზაფხულზე გამოსაყენებლად მაღალი ნალექის მქონე რეგიონებში, რადგან მას აქვს დაბალი მგრძნობელობა გამორეცხვის მიმართ</li>
                                                <li>ნაკლები დანაკარგი ნიადაგის ხსნარში ხანგრძლივი დაშლის გამო. მინდორზე არ არის „ზოლების“ ეფექტი - უფრო სტაბილური მოსავალი</li>
                                                <li>ნაკლებად ამჟავებს ნიადაგს - pH 10% UAN ხსნარი - 6,5</li>
                                                <li>გრძელვადიანი შენახვა ნამცხვრის გარეშე (შეიძლება შეიძინოთ სეზონამდე)</li>
                                            </ol>

                                            <div class="part mt-3">
                                                <h4 class="inner-title mb-2">პრეპარატის დანიშვნა:</h4>
                                                <p class="font-light">უნივერსალური მარცვლოვანი აზოტოვანი სასუქი, რომელიც შეიცავს აზოტს ამონიუმის და ნიტრატის სახით (33,5% აზოტი), რომელიც უზრუნველყოფს მცენარეთა კვებას მთელი ვეგეტაციის განმავლობაში.

სასუქი ვარგისია ადრე გაზაფხულზე გამოსაყენებლად მაღალი ნალექის მქონე რეგიონებში, რადგან მას აქვს დაბალი მგრძნობელობა გამორეცხვის მიმართ.</p>
                                            </div>
                                        </div>
                                ...
                                <div class="pro mb-4">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-part">
                                            <tr>
                                                <th>აზოტის საერთო (N), არანაკლებ</th><td>29-33.5%</td>
                                            </tr>
                                            <tr>
                                                <th>წყლის მასური ფრაქცია</th><td></td>
                                            </tr>
                                            <tr class="subtable">
