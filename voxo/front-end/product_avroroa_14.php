                        ...
                        <div class="row g-4">
                                    ...
                                    <div class="details-image ratio_asos">
                                        <div>
                                            <div class="product-image-tag">
                                                <img src="assets/images/products/avrora-14.jpg" id="zoom_01"
                                                    data-zoom-image="assets/images/products/avrora-14.jpg"
                            ...
                            <div class="col-md-7">
                                <div class="cloth-details-size">
                                    ...
                                    <h3 class="active-price-detail">საცალო ფასი: ₾<span id="unitprice">135.00</span></h3><h3 class="active-price-discount"> საბითუმო ფასი: ₾<span id="wholesaleprice">130.00</span></h3>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="desc">
                                <div class="shipping-chart">
                                    <div class="part">
                                        <h4 class="inner-title mb-2">ავრორა 14.14.23</h4>
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="part col-lg-8">
                                            ...
                                            <ol>
                                                ...
                                                <li>კალიუმის მაღალი შემცველობა</li>
                                                <li>შეიცავს გოგირდს მოსავლიანობისა და პროდუქტის ხარისხის გასაუმჯობესებლად</li>
                                                <li>გოგირდის გაზრდილი შემცველობა ზრდის მოსავლის კვებით ღირებულებას</li>
                                            ...
                                            <div class="part mt-3">
                                                ...
                                                <p class="font-light">დადებითად მოქმედებს მცენარის დაფესვიანებაზე განვითარების საწყის ეტაპებზე. ზრდის კულტურების წინააღმდეგობას არახელსაყრელი გარე ფაქტორების მიმართ (გვალვა, ჭარბი ტენიანობა), ამცირებს ხილსა და ბოსტნეულში ნიტრატების დაგროვებას, ზრდის მზა პროდუქციის შენახვის ვადას და კომერციულ მახასიათებლებს.</p>
                                            </div>
                                        </div>
                                ...
                                <div class="pro mb-4">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-part">
                                            <tr>
                                                <th>აზოტის საერთო (N), არანაკლებ</th><td>14%</td>
                                            </tr>
                                            <tr class="subtable">
                                                <th>ამონიუმის აზოტი, არანაკლებ</th><td>8%</td>
                                            </tr>
                                            <tr>
                                                <th>სულ ფოსფატები P2O5-ის მიხედვით, არანაკლებ</th><td>14%</td>
                                            </tr>
                                            <tr>
                                                <th>კალიუმი, არანაკლებ</th><td>23%</td>
                                            </tr>
                                            <tr>
