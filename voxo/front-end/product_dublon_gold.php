                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-7">
                            <div class="cloth-details-size">
                                ...
                                <h3 class="price-detail">₾<span id="pricetag">50.00</span> <del id="oldprice"></del>
                                    <span id="discount"></span></h3>
                                <h3 class="active-price-detail">საცალო ფასი: ₾<span id="unitprice">50.00</span></h3>
                                <h3 class="active-price-discount"> საბითუმო ფასი: ₾<span
                                        id="wholesaleprice">45.00</span></h3>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="desc">
                            <div class="shipping-chart">
                                <div class="part">
                                    <h4 class="inner-title mb-2">დუბლონ გოლდი</h4>
                                    <p class="font-light">კომბინირებული ჰერბიციდი ერთწლიანი და მრავალწლიანი მარცვლეულის,
                                        ერთწლოვანი და ზოგიერთი მრავალწლიანი ორფეხა სარეველების წინააღმდეგ სიმინდის
                                        კულტურებში
                                    </p>
                                </div>
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-lg-8">
                                        ...
                                        <ol>
                                            <li>მოქმედების ძალიან ფართო სპექტრი ორი აქტიური ნივთიერების კომბინაციის
                                                გამო, რომლებიც ავსებენ ერთმანეთს</li>
                                            <li>კულტურის დაცვის ხანგრძლივი პერიოდი</li>
                                            <li>ეკონომიური გამოყენება დაბალი მოხმარების სიჩქარის გამო</li>
                                            <li>თანამედროვე, ადვილად გამოსაყენებელი, ტრანსპორტირება და შესანახი
                                                მოსამზადებელი ფორმა</li>
                                        </ol>

                                        <div class="part mt-3">
                                            <h4 class="inner-title mb-2">პრეპარატის დანიშვნა:</h4>
                                            <p class="font-light">კომბინირებული სისტემური ჰერბიციდი მრავალი სახის წლიური
                                                და მრავალწლოვანი ბალახის და ერთწლოვანი და ზოგიერთი მრავალწლიანი ორფეხა
                                                სარეველების კონტროლისთვის სიმინდის კულტურებში.
                                            </p>
                                            <br>
                                            <h4 class="inner-title mb-2">გამოყენების რეკომენდაციები:</h4>
                                            <p class="font-light">დუბლინ გოლდი რეგისტრირებულია სიმინდის კულტურებზე
                                                გამოსაყენებლად (გარდა ზეთიანი სიმინდისა). სიმინდი მუშავდება მე-2 ფაზაში
                                                - 6 ფოთოლი ბალახის სიმაღლეზე 10 - 15 სმ, 1 ფაზაში - 4 ფოთოლი ერთწლოვანი
                                                ორფოთლიანი და მარცვლოვანი სარეველა.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-8 order-lg-2 mt-4">
                                        ...
                                        <p class="font-light">სამუშაო ხსნარი მზადდება შესხურებამდე დაუყოვნებლივ. გაზომეთ
                                            დუბლონ გოლდის საჭირო რაოდენობა თითო შემასხურებლის შევსებაზე. პრეპარატის
                                            სამუშაო ხსნარის მოსამზადებლად კონტეინერი (ვედრო) ივსება წყლით 1/4-ით, შემდეგ
                                            ემატება გაზომილი რაოდენობის ჰერბიციდი, აურიეთ საფუძვლიანად, ზემოდან ავსებენ
                                            წყალს მოცულობის 3/4-მდე. შემდეგ მუშა ხსნარს ამზადებენ შემდეგნაირად:
                                            გამფრქვევი ავზი ივსება დაახლოებით ნახევრად წყლით, ჩართულია მიქსერი, მასში
                                            ასხამენ ჰერბიციდის სამუშაო ხსნარს, ემატება ადიუ წებოს შესაბამისი რაოდენობა და
                                            წყალი იხსნება. დაემატა სრულ მოცულობას. სამუშაო ხსნარის მოსამზადებელ ჭურჭელს
                                            რამდენჯერმე რეცხავენ წყლით და ასხამენ შემასხურებელ ავზში.</p>
                                        <div class="part mt-3">
                                            <p class="font-light">მნიშვნელოვანია! ადიუ ბოლოს უნდა დაემატოს შემასხურებელ
                                                ავზს, წინააღმდეგ შემთხვევაში, უხვი ქაფის გამო, წებოვანი ნივთიერების
                                                დამატებისას შესაძლოა, ხსნარის ნაწილი გადმოვიღვაროს მფრქვეველი ავზიდან.
                                            </p>
                                        </div>
                                    </div>
