                                ...
                                <div class="details-image ratio_asos">
                                    <div>
                                        <div class="product-image-tag">
                                            <img src="assets/images/products/spray-3.jpg" id="zoom_01"
                                                data-zoom-image="assets/images/products/spray-3.jpg"
                        ...
                        <div class="col-md-7">
                            <div class="cloth-details-size">
                                ...
                                <div class="details-image-concept">
                                    <h2>პანდორას ელექტრო შემასხურებელი მრგალი</h2>
                                </div>
                                ...
                                <h3 class="price-detail">₾<span id="pricetag">210.00</span></h3>
                                ...
                                <div id="selectSize" class="addeffect-section product-description border-product">
                                    ...
                                    <div class="size-box">
                                        <ul>
                                            <li class="pricechange active" id="activeprice" value="210" realvalue="210">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="desc">
                            <div class="shipping-chart">
                                <div class="part">
                                    <h4 class="inner-title mb-2">პანდორას ელექტრო შემასხურებელი მრგალი</h4>
                                    <ul>
                                        <li>მოდელი: 16 ლიტრიანი ელექტრო შემასხურებელი</li>
                                        <li>ბრენდი: პანდორა - Pandora  </li>
                                        <li>სერიული ნომერი: CF-BY-16</li>
                                        <li>მოდელის ნომერი: CF-BY-16</li>
                                        <li>მოცულობა: 16 ლიტრი</li>
                                        <li>შეფუთვა: 1ცალი/ყუთში
</li>
                                        <li>Მთლიანი წონა: 6.8 კგ.
</li>
                                        <li>ზომა: 37x23.5x52 სმ
</li>
                                    </ul>
                                </div>
                            </div>
