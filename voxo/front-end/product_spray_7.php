                                ...
                                <div class="details-image ratio_asos">
                                    <div>
                                        <div class="product-image-tag">
                                            <img src="assets/images/products/spray-7.jpg" id="zoom_01"
                                                data-zoom-image="assets/images/products/spray-7.jpg"
                        ...
                        <div class="col-md-7">
                            <div class="cloth-details-size">
                                ...
                                <div class="details-image-concept">
                                    <h2>შემასხურებელი ბენზინის ძრავზე ROYAL PARTNER</h2>
                                </div>
                                ...
                                <h3 class="price-detail">₾<span id="pricetag">400.00</span></h3>
                                ...
                                <div id="selectSize" class="addeffect-section product-description border-product">
                                    ...
                                    <div class="size-box">
                                        <ul>
                                            <li class="pricechange active" id="activeprice" value="400" realvalue="400">
