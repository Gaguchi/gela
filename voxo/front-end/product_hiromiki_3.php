                                ...
                                <div class="details-image ratio_asos">
                                    <div>
                                        <div class="product-image-tag">
                                            <img src="assets/images/products/hiromiki-3.jpg" id="zoom_01"
                                                data-zoom-image="assets/images/products/hiromiki-3.jpg"
                        ...
                        <div class="col-md-7">
                            <div class="cloth-details-size">
                                ...
                                <div class="details-image-concept">
                                    <h2>ხელის კულტივატორი "ჰირომიკი" MQ170-4</h2>
                                </div>
                                ...
                                <h3 class="price-detail">₾<span id="pricetag">2475.00</span></h3>
                                ...
                                <div id="selectSize" class="addeffect-section product-description border-product">
                                    ...
                                    <div class="size-box">
                                        <ul>
                                            <li class="pricechange active" id="activeprice" value="2475" realvalue="2475">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="desc">
                            <div class="shipping-chart">
                                <div class="part">
                                    <h4 class="inner-title mb-2">ხელის კულტივატორი "ჰირომიკი" MQ170-4</h4>
                                    <ul>
                                        <li>მოდელი: MQ170-4</li>
