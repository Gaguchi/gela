                    ...
                    <div class="row g-4">
                                ...
                                <div class="details-image ratio_asos">
                                    <div>
                                        <div class="product-image-tag">
                                            <img src="assets/images/products/filter-3.jpg" id="zoom_01"
                                                data-zoom-image="assets/images/products/filter-3.jpg"
                        ...
                        <div class="col-md-7">
                            <div class="cloth-details-size">
                                ...
                                <h3 class="price-detail">₾<span id="pricetag">19.00</span></h3>
                                ...
                                <div id="selectSize" class="addeffect-section product-description border-product">
                                    ...
                                    <div class="size-box">
                                        <ul>
                                            <li class="pricechange active" id="activeprice" value="19" realvalue="19">
