                            ...
                            <div class="shipping-chart">
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-lg-8">
                                        ...
                                        <ol>
                                            <li>თითქმის ყველა სახის სარეველების განადგურება, მათ შორის მავნე, ასევე
                                                არასასურველი ხეების და ბუჩქების მცენარეულობა</li>
                                            <li>გამოყენების უნარი მთელ ტემპერატურულ დიაპაზონში, სადაც მცენარეები
                                                სიცოცხლისუნარიანია</li>
                                            <li>მოსავლის როტაციაში გამოყენების სრული უსაფრთხოება</li>
                                        </ol>

                                        <div class="part mt-3">
                                            <h4 class="inner-title mb-2">პრეპარატის დანიშვნა:</h4>
                                            <p class="font-light">არასელექტიური სისტემური ჰერბიციდი ერთწლიანი და
                                                მრავალწლიანი სარეველების და არასასურველი ხეებისა და ბუჩქების
                                                განადგურებისთვის.</p>
                                            <br>
                                            <h4 class="inner-title mb-2">გამოყენების რეკომენდაციები:</h4>
                                            <p class="font-light">ტორნადო გამოიყენება მცენარეული სარეველების ერთჯერადი
                                                შესხურებისთვის. ერთწლიანი მარცვლეული ყველაზე დაუცველია 5 სმ-ზე მეტი
                                                სიმაღლის მიღწევამდე, მრავალწლოვანი მარცვლეული - მინიმუმ 5-6 ფოთლით
                                                და 10-20 სმ სიმაღლით, ერთწლიანი ორფოთლიანი - ორი ფოთლის სტადიიდან
                                                ყვავილობამდე; მრავალწლოვანი ორწიფოები - როზეტის ფაზაში ყვავილობის
                                                დაწყებამდე და ყვავილობამდე (ეკლი - როზეტის ფაზაში დიამეტრით 10 - 20 სმ,
                                                მდოგვი - როზეტის ფაზაში - თვალთვალი, ბადე - როზეტის ფაზაში 10 - 12 სმ).
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="part col-lg-8 order-lg-2 mt-4">
                                        ...
                                        <p class="font-light">სამუშაო ხსნარის მოსამზადებლად წყალი უნდა იყოს სუფთა.
                                            წყალში სილის ან თიხის ნაწილაკების დიდმა რაოდენობამ შეიძლება გაანეიტრალოს
                                            პრეპარატის აქტიური ნივთიერება და შეამციროს მისი ეფექტურობა. მყარი წყლის
                                            გამოყენებისას (ელექტროგამტარობა 500 მიკროზიმენს/სმ-ზე მეტი), უნდა იქნას
                                            გამოყენებული მოქმედი ხსნარის დაბალი სიხშირე და პრეპარატის უფრო მაღალი დოზები
                                            და სამუშაო ხსნარს უნდა დაემატოს სოილენტის წყლის კონდიციონერი. ჯერ უნდა
                                            დაემატოს! მოხმარების საჭირო მაჩვენებელი შეირჩევა სპეციალურად მიღებული წყლის
                                            შემადგენლობის მიხედვით, პრეპარატში შემავალი ინდიკატორის საღებავის
                                            დახმარებით.
