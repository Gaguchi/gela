                                ...
                                <div class="details-image ratio_asos">
                                    <div>
                                        <div class="product-image-tag">
                                            <img src="assets/images/products/spray-6.jpg" id="zoom_01"
                                                data-zoom-image="assets/images/products/spray-6.jpg"
                        ...
                        <div class="col-md-7">
                            <div class="cloth-details-size">
                                ...
                                <div class="details-image-concept">
                                    <h2>დრაგონის ელექტრო შემასხურებელი</h2>
                                </div>
                                ...
                                <h3 class="price-detail">₾<span id="pricetag">135.00</span></h3>
                                ...
                                <div id="selectSize" class="addeffect-section product-description border-product">
                                    ...
                                    <div class="size-box">
                                        <ul>
                                            <li class="pricechange active" id="activeprice" value="135" realvalue="135">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="desc">
                            <div class="shipping-chart">
                                <div class="part">
                                    <h4 class="inner-title mb-2">დრაგონის ელექტრო შემასხურებელი</h4>
                                    <ul>
                                        <li>მოდელი: 16 ლიტრიანი ელექტრო შემასხურებელი</li>
                                        <li>ბრენდი: პანდორა - Pandora  </li>
                                        <li>სერიული ნომერი: CF-EU-611</li>
                                        <li>მოდელის ნომერი: CF-EU-611</li>
