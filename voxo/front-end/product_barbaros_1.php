                        ...
                        <div class="col-md-7">
                            <div class="cloth-details-size">
                                ...
                                <div class="details-image-concept">
                                    <h2>თხილის სარჩევი მანქანა 3HP/2,2KW</h2>
                                </div>
                                ...
                                <h3 class="price-detail">₾<span id="pricetag">4100.00</span></h3>
                                ...
                                <div id="selectSize" class="addeffect-section product-description border-product">
                                    ...
                                    <div class="size-box">
                                        <ul>
                                            <li class="pricechange active" id="activeprice" value="4100" realvalue="4100">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="desc">
                            <div class="shipping-chart">
                                <div class="part">
                                    <h4 class="inner-title mb-2">თხილის სარჩევი მანქანა 3HP/2,2KW</h4>
                                    <ul>
