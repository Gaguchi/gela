                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-7">
                                <div class="cloth-details-size">
                                    ...
                                    <h3 class="price-detail">₾<span id="pricetag">65.00</span> <del id="oldprice"></del> <span id="discount"></span></h3>
                                    <h3 class="active-price-detail">საცალო ფასი: ₾<span id="unitprice">65.00</span></h3><h3 class="active-price-discount"> საბითუმო ფასი: ₾<span id="wholesaleprice">60.00</span></h3><h3 class="mb-3"><span id="until-discount">დარჩა 10 საბითუმო ფასამდე</span></h3>
                                    <div id="selectSize" class="addeffect-section product-description border-product">
                                        ...
                                        <div class="size-box">
                                            <ul>
                                                <li class="pricechange active" id="activeprice" value="65" realvalue="60">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="desc">
                                <div class="shipping-chart">
                                    <div class="part">
                                        <h4 class="inner-title mb-2">გალანტი</h4>
                                        <p class="font-light">კონტაქტური მოქმედების ტოტალური ჰერბიციდი, დესიკანტი ხეხილის, ვაზის და თხილის ამონაყრების წინააღმდეგ</p>
                                    </div>
                                    <div class="part">
                                        <h4 class="inner-title mb-2">თავსებადობა</h4>
                                        <p class="font-light">პრეპარატი თავსებადია სხვა პესტიციდებთან და აგროქიმიკატებთან. სამუშაო ხსნარის მომზადების წინ უნდა შემოწმდეს პრეპარატებთან თავსებადობაზე.</p>
                                    </div>
                                    <div class="part">
                                        <h4 class="inner-title mb-2">მოქმედების მექანიზმი</h4>
                                    ...
                                    <div class="table-responsive">
                                                <img src="assets/images/galant_table.png" alt="" srcset="">
                                            </div>
                                </div>
                            </div>
                                ...
                                <div class="pro mb-4">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-part">
                                            <tr>
                                                <th>ამონიუმის გლუფოსინატი</th><td>150 გ/ლ.</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
