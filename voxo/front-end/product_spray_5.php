                                ...
                                <div class="details-image ratio_asos">
                                    <div>
                                        <div class="product-image-tag">
                                            <img src="assets/images/products/spray-5.jpg" id="zoom_01"
                                                data-zoom-image="assets/images/products/spray-5.jpg"
                        ...
                        <div class="col-md-7">
                            <div class="cloth-details-size">
                                ...
                                <div class="details-image-concept">
                                    <h2>პანდორას ელექტრო და მექანიკური შემასხურებელი</h2>
                                </div>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="desc">
                            <div class="shipping-chart">
                                <div class="part">
                                    <h4 class="inner-title mb-2">პანდორას ელექტრო და მექანიკური შემასხურებელი</h4>
                                    <ul>
                                        <li>მოდელი: 16 ლიტრიანი ელექტრო შემასხურებელი</li>
                                        <li>ბრენდი: პანდორა - Pandora  </li>
                                        <li>სერიული ნომერი: CF-EU-16D</li>
                                        <li>მოდელის ნომერი: CF-EU-16D</li>
                                        <li>მოცულობა: 16 ლიტრი</li>
                                        <li>შეფუთვა: 1ცალი/ყუთში
</li>
                                        <li>Მთლიანი წონა: 6.8 კგ.
</li>
                                        <li>ზომა: 38x20.7x52.5 სმ
</li>
                                    </ul>
                                </div>
                            </div>
