                        ...
                        <div class="row g-4">
                                    ...
                                    <div class="details-image ratio_asos">
                                        <div>
                                            <div class="product-image-tag">
                                                <img src="assets/images/products/sulfavita.jpg" id="zoom_01"
                                                    data-zoom-image="assets/images/products/sulfavita.jpg"
                            ...
                            <div class="col-md-7">
                                <div class="cloth-details-size">
                                    ...
                                    <h3 class="price-detail">₾<span id="pricetag">18.00</span> <del id="oldprice"></del> <span id="discount"></span></h3>
                                    <h3 class="active-price-detail">საცალო ფასი: ₾<span id="unitprice">18.00</span></h3><h3 class="active-price-discount"> საბითუმო ფასი: ₾<span id="wholesaleprice">15.00</span></h3><h3 class="mb-3"><span id="until-discount">დარჩა 10 საბითუმო ფასამდე</span></h3>
                                    ...
                                    <div id="selectSize" class="addeffect-section product-description border-product">
                                        ...
                                        <div class="size-box">
                                            <ul>
                                                <li class="pricechange active" id="activeprice" value="18" realvalue="15">
                            ...
                            <div class="tab-pane fade show active" id="desc">
                                <div class="shipping-chart">
                                    ...
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <p class="font-light">სულფოვიტა არის M02 ჯგუფის ფუნგიციდი. M02 ფუნგიციდების მრავალჯერადმა გამოყენებამ შესაძლოა გამოიწვიოს ამა თუ იმ სოკოვანი დაავადების გენეტიკური თვისებების ცვლილება და გახდეს მის მიმართ რეზისტენტული. რეზისტენტობის წარმოქმნის თავიდან ასაცილებლად სულფოვიტა და სხვა ქიმიური კლასის პრეპარატები გამოიყენეთ მონაცვლეობით.</p>
                                        </div>
                                        <div class="col-lg-4">
